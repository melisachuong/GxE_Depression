...
theme_bw() + 
theme(legend.title = element_text(size=15), legend.text = element_text(size=15), axis.title = element_text(size=15))

ggsave(file="test.svg", plot=plot1, width=8, height=6)
ggsave(file="test.png", plot=plot1, width=8, height=6)
