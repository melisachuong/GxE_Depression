...
pcs <- read.csv("../../phenotypes/AT_pcs.csv", header=T) # n =  150939
pcs <- pcs %>%
...
total_analysis_sample <- pcs %>%
                         inner_join(., gxe_full_ids, all=FALSE) # N = 142375

write.table(total_analysis_sample, "AT_profile.txt", row.names=F, quote=F)

#################################################
# creating cluster specific _profile.txt files  #
#################################################

ids <- read.table("AT_profile.txt", header=T)
...
for (cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  write.table(cluster_erm_ids, paste0("AT_", cluster,"_profile.txt"), row.names=F, quote=F)
}
...
for (cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  cluster_ids <- read.table(paste0("./AT_", cluster, "_profile.txt"), header=T)
  cluster_ids <- cluster_ids[,c(1:2)]

  write.table(cluster_ids, paste0("gxe_AT_keepIDs_", cluster,".txt"), col.names=F, row.names=F, quote=F)
}
...
ids <- read.table(paste0("./phenotypes/gxe_AT_keepIDs_", cluster, ".txt"), header=F)
cluster_info <- ids %>%
                rename(FID = V1,
                       IID = V2) %>%
...
write.csv(dem, paste0(cluster, "_FULL_AT_demographics.csv"), row.names=F)
...
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_AT_keepIDs_north.txt --make-bed --out analysis_sample_AT_north
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_AT_keepIDs_midnorth.txt --make-bed --out analysis_sample_AT_midnorth
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_AT_keepIDs_midsouth.txt --make-bed --out analysis_sample_AT_midsouth
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_AT_keepIDs_southwest.txt --make-bed --out analysis_sample_AT_southwest
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_AT_keepIDs_southeast.txt --make-bed --out analysis_sample_AT_southeast

```
2. We will now compute GRMs for each of our clusters specified. We have sample sizes ranging from 20,000-40,000, so this may require a lot of memory, depending on how you want to output your GRM (binary takes up less memory).
...
gcta64 --bfile analysis_sample_AT_north --make-grm --out analysis_sample_AT_north --thread-num 5

gcta64 --bfile analysis_sample_AT_midnorth --make-grm --out analysis_sample_AT_midnorth --thread-num 5

gcta64 --bfile analysis_sample_AT_midsouth --make-grm --out analysis_sample_AT_midsouth --thread-num 5

gcta64 --bfile analysis_sample_AT_southeast --make-grm --out analysis_sample_AT_southeast --thread-num 5

gcta64 --bfile analysis_sample_AT_southwest --make-grm --out analysis_sample_AT_southwest --thread-num 5
...
for(cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  cluster <- ReadGRMBin(paste0("analysis_sample_AT_", cluster))
...
gcta64 --grm ../analysis_sample_AT_north --pca 15 --out AT_north_pcs --thread-num 12
gcta64 --grm ../analysis_sample_AT_midnorth --pca 15 --out AT_midnorth_pcs --thread-num 12
gcta64 --grm ../analysis_sample_AT_midsouth --pca 15 --out AT_midsouth_pcs --thread-num 12
gcta64 --grm ../analysis_sample_AT_southwest --pca 15 --out AT_southwest_pcs --thread-num 12
gcta64 --grm ../analysis_sample_AT_southeast --pca 15 --out AT_southeast_pcs --thread-num 12

```

# ENVIRONMENTAL RELATIONSHIP MATRICES: {.tabset}

## ERM Adult Trauma (5 Principal Components)  
...
../../erm/osca_Linux --efile ../phenotypes/AT_north_profile.txt --make-bod --out AT_north

../../erm/osca_Linux --efile ../phenotypes/AT_midnorth_profile.txt --make-bod --out AT_midnorth

../../erm/osca_Linux --efile ../phenotypes/AT_midsouth_profile.txt --make-bod --out AT_midsouth

../../erm/osca_Linux --efile ../phenotypes/AT_southwest_profile.txt --make-bod --out AT_southwest

../../erm/osca_Linux --efile ../phenotypes/AT_southeast_profile.txt --make-bod --out AT_southeast
...
../../erm/osca_Linux --befile AT_north --make-orm --out AT_north --thread-num 5

../../erm/osca_Linux --befile AT_midnorth --make-orm --out AT_midnorth --thread-num 5

../../erm/osca_Linux --befile AT_midsouth --make-orm --out AT_midsouth --thread-num 5

../../erm/osca_Linux --befile AT_southwest --make-orm --out AT_southwest --thread-num 5

../../erm/osca_Linux --befile AT_southeast --make-orm --out AT_southeast --thread-num 5
...
for(cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  ids <- read.table(paste0("../analysis_sample_AT_", cluster, ".grm.id"), header=F)
  colnames(ids) <- c("FID", "IID")
  
  pcs <- read.table(paste0("AT_", cluster, "_pcs.eigenvec"), header=F)
  ...
  write.table(discrete, paste0("AT_", cluster, "_cov"), col.names=F, row.names=F, quote=F)
  write.table(quant, paste0("AT_", cluster, "_q_cov"), col.names=F, row.names=F, quote=F)
...
cov <- read.table(paste0("AT_", cluster, "_cov"), header=F)

cov <- cov[,-3] #removing sex column

write.table(cov, paste0("AT_", cluster, "_cov2"), row.names=F, quote=F, col.names=F)
...
gcta64 --grm ../../full_sample_grms/analysis_sample_AT_north --reml --pheno ../../../cidi.phen --out h2_AT_cidi_n --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/AT_north_q_cov --covar ../../full_sample_grms/pca/AT_north_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_AT_midnorth --reml --pheno ../../../cidi.phen --out h2_AT_cidi_mn --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/AT_midnorth_q_cov --covar ../../full_sample_grms/pca/AT_midnorth_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_AT_midsouth  --reml --pheno ../../../cidi.phen --out h2_AT_cidi_ms --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/AT_midsouth_q_cov --covar ../../full_sample_grms/pca/AT_midsouth_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_AT_southwest --reml --pheno ../../../cidi.phen --out h2_AT_cidi_sw --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/AT_southwest_q_cov --covar ../../full_sample_grms/pca/AT_southwest_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_AT_southeast  --reml --pheno ../../../cidi.phen --out h2_AT_cidi_se --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/AT_southeast_q_cov --covar ../../full_sample_grms/pca/AT_southeast_cov --reml-est-fix
...
gcta64 --grm ../../AT_north --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_AT_cidi_erm_n --thread-num 10  --qcovar ../../../grm/full_sample_grms/pca/AT_north_q_cov --covar ../../../grm/full_sample_grms/pca/AT_north_cov --reml-est-fix --reml-priors 0 1  

gcta64 --grm ../../AT_midnorth --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_AT_cidi_erm_mn --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/AT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midnorth_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../AT_midsouth --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_AT_cidi_erm_ms --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/AT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midsouth_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../AT_southwest --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_AT_cidi_erm_sw --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/AT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southwest_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../AT_southeast --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_AT_cidi_erm_se --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/AT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southeast_cov --reml-est-fix --reml-priors 0 1
...
```
../../AT_north
../../../grm/full_sample_grms/analysis_sample_AT_north
...
gcta64 --mgrm mgrm_G+E_north.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_G+E_n --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_north_q_cov --covar ../../../grm/full_sample_grms/pca/AT_north_cov --reml-lrt 1 --reml-est-fix  

gcta64 --mgrm mgrm_G+E_midnorth.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_G+E_mn --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midnorth_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_midsouth.txt  --reml --pheno ../../../cidi.phen --out h2_AT_cidi_G+E_ms --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midsouth_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_southwest.txt  --reml --pheno ../../../cidi.phen --out h2_AT_cidi_G+E_sw --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southwest_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_southeast.txt   --reml --pheno ../../../cidi.phen --out h2_AT_cidi_G+E_se --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southeast_cov --reml-lrt 1 --reml-est-fix
...
```
cp analysis_sample_AT_north.grm.N.bin GxAT_north.grm.N.bin

cp analysis_sample_AT_midnorth.grm.N.bin GxAT_midnorth.grm.N.bin

cp analysis_sample_AT_midsouth.grm.N.bin GxAT_midsouth.grm.N.bin

cp analysis_sample_AT_southwest.grm.N.bin GxAT_southwest.grm.N.bin

cp analysis_sample_AT_southeast.grm.N.bin GxAT_southeast.grm.N.bin
...
```
../alg1_files/analysis_sample_AT_north

../alg1_files/AT_north

../alg1_files/GxAT_north
...
gcta64 --mgrm mgrm_GxE_north.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_GxE_n --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_north_q_cov --covar ../../../grm/full_sample_grms/pca/AT_north_cov --reml-lrt 3 --reml-est-fix  

gcta64 --mgrm mgrm_GxE_midnorth.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_GxE_mn --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midnorth_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_midsouth.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_GxE_ms --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/AT_midsouth_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_southwest.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_GxE_sw --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southwest_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_southeast.txt --reml --pheno ../../../cidi.phen --out h2_AT_cidi_GxE_se --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/AT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/AT_southeast_cov --reml-lrt 3 --reml-est-fix
