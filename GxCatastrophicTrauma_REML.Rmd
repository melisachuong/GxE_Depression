---
title: "GxCatastrophicTrauma_reml"
...
pcs <- read.csv("../../phenotypes/CAT_pcs.csv", header=T) # n =  154295
pcs <- pcs %>%
       select(FID = f.eid, PC1:PC6)
...
total_analysis_sample <- pcs %>%
                         inner_join(., gxe_full_ids, all=FALSE) # N = 145399

write.table(total_analysis_sample, "CAT_profile.txt", row.names=F, quote=F)

#################################################
# creating cluster specific _profile.txt files  #
#################################################

ids <- read.table("CAT_profile.txt", header=T)
...
for (cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  write.table(cluster_erm_ids, paste0("CAT_", cluster,"_profile.txt"), row.names=F, quote=F)
}
...
for (cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  cluster_ids <- read.table(paste0("./CAT_", cluster, "_profile.txt"), header=T)
  cluster_ids <- cluster_ids[,c(1:2)]

  write.table(cluster_ids, paste0("gxe_CAT_keepIDs_", cluster,".txt"), col.names=F, row.names=F, quote=F)
}
...
ids <- read.table(paste0("./phenotypes/gxe_CAT_keepIDs_", cluster, ".txt"), header=F)
...
write.csv(dem, paste0(cluster, "_FULL_CAT_demographics.csv"), row.names=F)
...
The first thing we need to do is create separate binary plink files for participants in the different geographical clusters
...
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_CAT_keepIDs_north.txt --make-bed --out analysis_sample_CAT_north
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_CAT_keepIDs_midnorth.txt --make-bed --out analysis_sample_CAT_midnorth
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_CAT_keepIDs_midsouth.txt --make-bed --out analysis_sample_CAT_midsouth
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_CAT_keepIDs_southwest.txt --make-bed --out analysis_sample_CAT_southwest
plink --bfile ../../../UKBgenotype --keep ../phenotypes/gxe_CAT_keepIDs_southeast.txt --make-bed --out analysis_sample_CAT_southeast

```

We will now compute GRMs for each of our clusters specified. We have sample sizes ranging from 20,000-40,000, so this may require a lot of memory, depending on how you want to output your GRM (binary takes up less memory).

The estimated maximum amount of memory used is ~10 GB, requesting a factor of 8 GB to avoid node allocation failure (remember to run the following script separately for each gcta code).
...
gcta64 --bfile analysis_sample_CAT_north --make-grm --out analysis_sample_CAT_north --thread-num 5

gcta64 --bfile analysis_sample_CAT_midnorth --make-grm --out analysis_sample_CAT_midnorth --thread-num 5

gcta64 --bfile analysis_sample_CAT_midsouth --make-grm --out analysis_sample_CAT_midsouth --thread-num 5

gcta64 --bfile analysis_sample_CAT_southeast --make-grm --out analysis_sample_CAT_southeast --thread-num 5

gcta64 --bfile analysis_sample_CAT_southwest --make-grm --out analysis_sample_CAT_southwest --thread-num 5
...
for(cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  cluster <- ReadGRMBin(paste0("analysis_sample_CAT_", cluster))
...
gcta64 --grm ../analysis_sample_CAT_north --pca 15 --out CAT_north_pcs --thread-num 12
gcta64 --grm ../analysis_sample_CAT_midnorth --pca 15 --out CAT_midnorth_pcs --thread-num 12
gcta64 --grm ../analysis_sample_CAT_midsouth --pca 15 --out CAT_midsouth_pcs --thread-num 12
gcta64 --grm ../analysis_sample_CAT_southwest --pca 15 --out CAT_southwest_pcs --thread-num 12
gcta64 --grm ../analysis_sample_CAT_southeast --pca 15 --out CAT_southeast_pcs --thread-num 12

```

# ENVIRONMENTAL RELATIONSHIP MATRICES: {.tabset}  

## ERM Catastrophic Trauma (6 Principal Components)

Will be making use of the software OSCA https://cnsgenomics.com/software/osca/#DataManagement  

This is actually a software which computes relationship matrices using individuals methylation/expression or other -omics data; however here we will use the software on our trauma PCs.  

We need to convert our .txt file with FID, IID and trauma PC data into a bod file format so it can be used by OSCA  
...
../../erm/osca_Linux --efile ../phenotypes/CAT_north_profile.txt --make-bod --out CAT_north

../../erm/osca_Linux --efile ../phenotypes/CAT_midnorth_profile.txt --make-bod --out CAT_midnorth

../../erm/osca_Linux --efile ../phenotypes/CAT_midsouth_profile.txt --make-bod --out CAT_midsouth

../../erm/osca_Linux --efile ../phenotypes/CAT_southwest_profile.txt --make-bod --out CAT_southwest

../../erm/osca_Linux --efile ../phenotypes/CAT_southeast_profile.txt --make-bod --out CAT_southeast
...
../../erm/osca_Linux --befile CAT_north --make-orm --out CAT_north --thread-num 5

../../erm/osca_Linux --befile CAT_midnorth --make-orm --out CAT_midnorth --thread-num 5

../../erm/osca_Linux --befile CAT_midsouth --make-orm --out CAT_midsouth --thread-num 5

../../erm/osca_Linux --befile CAT_southwest --make-orm --out CAT_southwest --thread-num 5

../../erm/osca_Linux --befile CAT_southeast --make-orm --out CAT_southeast --thread-num 5
...
for(cluster in c("north", "midnorth", "midsouth", "southwest", "southeast")){
  ...
  ids <- read.table(paste0("../analysis_sample_CAT_", cluster, ".grm.id"), header=F)
  colnames(ids) <- c("FID", "IID")
  
  pcs <- read.table(paste0("CAT_", cluster, "_pcs.eigenvec"), header=F)
  ...
  write.table(discrete, paste0("CAT_", cluster, "_cov"), col.names=F, row.names=F, quote=F)
  write.table(quant, paste0("CAT_", cluster, "_q_cov"), col.names=F, row.names=F, quote=F)
...
cov <- read.table(paste0("CAT_", cluster, "_cov"), header=F)

cov <- cov[,-3] #removing sex column

write.table(cov, paste0("CAT_", cluster, "_cov2"), row.names=F, quote=F, col.names=F)
...
gcta64 --grm ../../full_sample_grms/analysis_sample_CAT_north --reml --pheno ../../../cidi.phen --out h2_cidi_n --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/CAT_north_q_cov --covar ../../full_sample_grms/pca/CAT_north_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_CAT_midnorth --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_mn --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/CAT_midnorth_q_cov --covar ../../full_sample_grms/pca/CAT_midnorth_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_CAT_midsouth  --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_ms --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/CAT_midsouth_q_cov --covar ../../full_sample_grms/pca/CAT_midsouth_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_CAT_southwest --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_sw --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/CAT_southwest_q_cov --covar ../../full_sample_grms/pca/CAT_southwest_cov --reml-est-fix

gcta64 --grm ../../full_sample_grms/analysis_sample_CAT_southeast  --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_se --thread-num 8 --prevalence 0.28 --qcovar ../../full_sample_grms/pca/CAT_southeast_q_cov --covar ../../full_sample_grms/pca/CAT_southeast_cov --reml-est-fix
...
gcta64 --grm ../../CAT_north --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_CAT_cidi_erm_n --thread-num 10  --qcovar ../../../grm/full_sample_grms/pca/CAT_north_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_north_cov --reml-est-fix --reml-priors 0 1  

gcta64 --grm ../../CAT_midnorth --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_CAT_cidi_erm_mn --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/CAT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midnorth_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../CAT_midsouth --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_CAT_cidi_erm_ms --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/CAT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midsouth_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../CAT_southwest --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_CAT_cidi_erm_sw --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/CAT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southwest_cov --reml-est-fix --reml-priors 0 1

gcta64 --grm ../../CAT_southeast --reml --prevalence 0.28 --pheno ../../../cidi.phen --out h2_CAT_cidi_erm_se --thread-num 10 --qcovar ../../../grm/full_sample_grms/pca/CAT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southeast_cov --reml-est-fix --reml-priors 0 1
...
```
../../CAT_north
../../../grm/full_sample_grms/analysis_sample_CAT_north
...
gcta64 --mgrm mgrm_G+E_north.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_G+E_n --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_north_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_north_cov --reml-lrt 1 --reml-est-fix  

gcta64 --mgrm mgrm_G+E_midnorth.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_G+E_mn --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midnorth_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_midsouth.txt  --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_G+E_ms --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midsouth_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_southwest.txt  --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_G+E_sw --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southwest_cov --reml-lrt 1 --reml-est-fix

gcta64 --mgrm mgrm_G+E_southeast.txt   --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_G+E_se --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southeast_cov --reml-lrt 1 --reml-est-fix
...
vi RunHadamardP_cat_north.sh

```
NIND=25590
G1=$'analysis_sample_CAT_north'
G2=$'CAT_north'
Out=$'GxCAT_north'
...
```
cp analysis_sample_CAT_north.grm.N.bin GxCAT_north.grm.N.bin

cp analysis_sample_CAT_midnorth.grm.N.bin GxCAT_midnorth.grm.N.bin

cp analysis_sample_CAT_midsouth.grm.N.bin GxCAT_midsouth.grm.N.bin

cp analysis_sample_CAT_southwest.grm.N.bin GxCAT_southwest.grm.N.bin

cp analysis_sample_CAT_southeast.grm.N.bin GxCAT_southeast.grm.N.bin
...
```
../alg1_files/analysis_sample_CAT_north

../alg1_files/CAT_north

../alg1_files/GxCAT_north
...
gcta64 --mgrm mgrm_GxE_north.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_GxE_n --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_north_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_north_cov --reml-lrt 3 --reml-est-fix  

gcta64 --mgrm mgrm_GxE_midnorth.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_GxE_mn --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_midnorth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midnorth_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_midsouth.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_GxE_ms --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_midsouth_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_midsouth_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_southwest.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_GxE_sw --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_southwest_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southwest_cov --reml-lrt 3 --reml-est-fix

gcta64 --mgrm mgrm_GxE_southeast.txt --reml --pheno ../../../cidi.phen --out h2_CAT_cidi_GxE_se --thread-num 10 --prevalence 0.28 --qcovar ../../../grm/full_sample_grms/pca/CAT_southeast_q_cov --covar ../../../grm/full_sample_grms/pca/CAT_southeast_cov --reml-lrt 3 --reml-est-fix
